...
<table width="760" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    ...
    <form action="getBookList.jsp" method="post">
    <table width="553" height="183" border="0" cellpadding="0" cellspacing="0" background="images/bg6.jpg">
      ...
      <tr>
        ...
        <td align="center">          <input type="radio" name="book" value="1"></td>
      </tr>
      <tr>
        <td height="31"><font color="#006600"> 　　　　杭州双卧三日游</font></td>
        <td align="center"><input type="radio" name="book" value="2"></td>
      </tr>
      <tr>
        <td height="27"><font color="#006600">　　　　黄山双飞五日游</font></td>
        <td align="center"><input type="radio" name="book" value="3"></td>
      </tr>
      <tr>
        <td height="35"><font color="#006600">　　　　云南雪山双飞七日游</font></td>
        <td align="center"><input type="radio" name="book" value="4"></td>
      </tr> 
	   <tr>
